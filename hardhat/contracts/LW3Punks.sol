...
contract LW3Punks is ERC721Enumerable, Ownable {
     ...
     * Constructo for LW3P takes in the baseURI to set _baseTokenURI for the collection.
     */

    constructor(
        string memory baseURI
    ) Ownable(msg.sender) ERC721("LW3Punks", "LW3P") {
    ...
    */
    ...
    /**
     * @dev tokenURIi overrides the Openzeppelin's ERC721 implementation for tokenURI function
    ...
    function tokenURI(
        ...
        // If baseURI is empty retun an empty string
        return
    ...
    */
    ...
    // Function to receive Ether. msg.data must be empty to
